...
const PaymentSuccess = () => {
  ...
  const [referenceNumbers, setreferenceNumber] = useState();
  const referenceNumberGetting = async () => {
    const responce = await axios.post(process.env.REACT_APP_CHEKING_PAYMENT);
    console.log("responce", responce.data);
    setreferenceNumber(responce);
  };
  useEffect(() => {
    referenceNumberGetting();
  }, []);
  console.log("referenceNumber", referenceNumbers);
